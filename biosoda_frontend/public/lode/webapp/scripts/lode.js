...
function _parseOptions(options) {
    ...
    var _options = $.extend({
        'servlet_base': 'https://www.ebi.ac.uk/rdf/services/servlet',
    ...
    if (match) {
        if (match[1].toUpperCase() == 'CONSTRUCT' || match[1].toUpperCase() == 'DESCRIBE') {
            ...
            if (rendering.match(/HTML/)) {
                ...
                window.location.href = loadestarQueryService + "?query=" + encodeURIComponent(querytext) + "&format=RDF/XML";
            }
            else if (rendering.match(/JSON-LD/)) {
                window.location.href = loadestarQueryService + "?query=" + encodeURIComponent(querytext) + "&format=JSON-LD";
            }
            else if (rendering.match(/N3/)) {
                window.location.href = loadestarQueryService + "?query=" + encodeURIComponent(querytext) + "&format=N3";
            }
            else  {
            ...
            if (rendering.match(/HTML/)) {
                ...
                window.location.href = loadestarQueryService + "?query=" + encodeURIComponent(querytext) + "&format=XML&limit=" + limit + "&offset=" + offset + "&inference=" + rdfs;
            }
            else if (rendering.match(/JSON$/)) {
                window.location.href = loadestarQueryService + "?query=" + encodeURIComponent(querytext) + "&format=JSON&limit=" + limit + "&offset=" + offset+ "&inference=" + rdfs;
            }
            else if (rendering.match(/CSV/)) {
                window.location.href = loadestarQueryService + "?query=" + encodeURIComponent(querytext) + "&format=CSV&limit=" + limit + "&offset=" + offset+ "&inference=" + rdfs;
            }
            else if (rendering.match(/TSV/)) {
                window.location.href = loadestarQueryService + "?query=" + encodeURIComponent(querytext) + "&format=TSV&limit=" + limit + "&offset=" + offset+ "&inference=" + rdfs;
            }
            else  {
...
function renderXML(uri) {
    ...
    if (queryString.match(/uri=/)) {
        ...
        window.location.href = loadestarQueryService + "?query=" + encodeURIComponent("describe<" + param + ">") + "&format=RDF/XML";
    }
    else if (uri != undefined) {
        window.location.href = loadestarQueryService + "?query=" + encodeURIComponent("describe<" + uri + ">") + "&format=RDF/XML";
    }
...
function renderN3(uri) {
    ...
    if (queryString.match(/uri=/)) {
        var param = this._betterUnescape(queryString.match(/uri=([^&]*)/)[1]);
        window.location.href = loadestarQueryService + "?query=" + encodeURIComponent("describe<" + param + ">") + "&format=N3";
    }
    else if (uri != undefined) {
        window.location.href = loadestarQueryService + "?query=" + encodeURIComponent("describe<" + uri + ">") + "&format=N3";
    }
}
...
function renderJson(uri) {
    ...
    if (queryString.match(/uri=/)) {
        var param = this._betterUnescape(queryString.match(/uri=([^&]*)/)[1]);
        window.location.href = loadestarQueryService + "?query=" + encodeURIComponent("describe<" + param + ">") + "&format=JSON-LD";
    }
    else if (uri != undefined) {
        window.location.href = loadestarQueryService + "?query=" + encodeURIComponent("describe<" + uri + ">") + "&format=JSON-LD";
    }
}

function _getPrefixes () {
    var prefixes = '';
    for (var prefix in this.loadstarNamespaces) {
